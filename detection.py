    ...
    while cap.isOpened():
        ...
        try:
            ...
            if angle_left >= 160 and angle_right >= 160 and incline_right >= 70 and incline_left >= 70:
                ...
                cv2.putText(image, "T-Pose completed!", (20, 40), cv2.FONT_HERSHEY_TRIPLEX, 1.0, (0, 255, 0), 3)
            ...
            if angle_left <= 60 and angle_right <= 60 and gap <= 0.07:
                mp_drawing.draw_landmarks(image, results.pose_landmarks, mp_pose.POSE_CONNECTIONS,
                                          mp_drawing.DrawingSpec(color=(0, 0, 255), thickness=2, circle_radius=1),
                                          mp_drawing.DrawingSpec(color=(0, 255, 0), thickness=2, circle_radius=2))
                cv2.putText(image, "Focus attained!", (20, 40), cv2.FONT_HERSHEY_TRIPLEX, 1.0, (0, 255, 0), 3)

            else:
                cv2.putText(image, "Stay focused friend!", (20, 40), cv2.FONT_HERSHEY_TRIPLEX, 1.0, (0, 0, 255), 3)
